...
GameControllerListener::GameControllerListener (const GameControllerListener &game_controller_listener) :
	number_of_joysticks(game_controller_listener.number_of_joysticks) {
}
